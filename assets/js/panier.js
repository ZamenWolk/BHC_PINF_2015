...
$(document).ready(function() {
	if (modeTest) {
		...
		$("#myPanier").html('<h1 class="align">&nbsp;Mon panier</h1><hr>'+
            	...
            	'	<div class="col-md-1 align" id="imgItem1"><img src="../img/item1.jpg" height="60px" width="60px"/></div>'+
            	...
            	'	<div class="col-md-1 align" id="imgItem2"><img src="../img/item1.jpg" height="60px" width="60px"/></div>'+
